...
function ClassPage (props) {
  ...
  const classUid = props.location.state.classId
  const isInstructor = props.location.state.isInstructor
      ...
      <div>
         <div className='component bg-purple-600 bg-opacity-80 mx-auto h-14 flex justify-between'>
              ...
              <Tabs value={selectedTab} onChange={handleChange}>
                ...
                { selectedTab === 0 &&
          <ClassPageStream classId={props.location.state.classId}
        ...
        { selectedTab === 1 &&
          <PeoplePage classId={props.location.state.classId}
            isInstructor={props.location.state.isInstructor}/> }
